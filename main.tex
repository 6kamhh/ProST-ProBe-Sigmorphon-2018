...
Nach etwas anfänglicher Skepsis haben wir den Schritt tatsächlich gewagt, und der Arbeitsbereich \texttt{NATS} hat sich dankenswerterweise sogar dazu bereit erklärt, uns finanziell zu unterstützen und die Reisekosten zu erstatten. Mit einem selbst erstellten Poster\footnote{Zum Zeitpunkt der Erstellung dieses Berichts hängt das Poster aktuell in Raum F-432} \todo{Poster verlinken/in den Anhang?} im Gepäck, welches die Inhalte des Papers erneut zusammenfasst und illustiert, ging es dann am 31. Oktober nach Brüssel.
...
% Habe meine Shell-Skripting Fähigkeiten enorm ausgebaut, inbs. im Hinblick auf Verteilung über mehrere Rechner
Automatisierung ist Trumpf.
Um Änderungen zur vermeintlichen Verbesserung schnell evaluieren zu können, ist es essenziell die Auswirkung einer einzelnen Anpassungen auf die Ergebnisse für alle Trainingsdaten verteilt über mehrere Rechner automatisiert bearbeiten zu lassen.
...
% Unterschiedliche Erwartungen, wie viel wir machen (wollen), wie gut es werden soll, wie viel Zeit man investiert etc. innerhalb des Teams
% Zeitgleiche Zusammenarbeit schwierig, wenn alle 3 nebenbei arbeiten und verschiedene Kurse haben - daraus resultierte strikte Trennung und wenig Wissensaustausch

Retrospektiv gesehen, hatten wir im Team abweichende Erwartungen wie viel wir machen wollen, wie gut unser System werden soll und wie viel Zeit man dafür investiert.
Das hätten wir schon ggf. während der Gruppenfindung oder spätestens zum Start der Bearbeitung des Shared Tasks herausarbeiten sollen.
Dabei half es wenig, dass sich die zeitgleiche, gemeinsame Zusammenarbeit als schwierig gestaltete und effektiv auf die Stunden während der offiziellen Projekt-Zeiten beschränkte. Es ließen sich keine passenden Zeiten finden, da wir alle nebenbei gearbeitet haben und zusätzlich unterschiedliche Kurse besucht haben.
Daraus resultierte eine relativ strikte Trennung bei der Aufgabenverteilung und verringerter Wissensaustausch, auch wenn wir versucht haben, die Stunden am Donnerstag während der Projekt-Zeiten vorrangig dafür zu verwenden, den anderen Gruppenmitgliedern das eigene Werk der letzten Woche zu erklären.

% Anwenden / selber Entwickeln von NNs gibt tiefgegehndes Verständis, was keine Vorleseung schafft - insb. Sequenz-Verarb., einbau anderer Nicht-standard komponenten wie Transducer sowie Einbringen und Ummünzen anderer Ideen auf das eigene NN waren klasse Erfahrungen (GLobalNorm., eigene Loss-Fkt, Beam-Dec), wird mir in Zukunft injedem Fall behilflich sein, bzw. war schon beim Lesen von Papern seitdem
% Es hat viel Spaß gemacht, das System zu verbessern, um noch ein paar Prozentonukte mehr herauszuholen
% Python mit PyTorch erlaubt schnelles Entwickeln + gutes Debugging
% Eine typisierte & kompilierte Sprache ziehe ich Python ab einem gewissen Umfang ganz klar vor (ich weiß, dass Python sowohl typisiert, als auch kompiliert werden kann, aber das hilft bei den verwendeten Libs auch nicht)
% Ein Paper zu veröffentlichen ist so wie Arbeit wie erwaret.. aber sehr cool, wenn es geschafft ist
% Wissenschaftliche Literaturarbeit kann ewig dauern, wenn man Quellen von Quellen liest.. aber man stößt dabei auf spannende Aspekte
% Im Rahmen der Seminararbeit habe ich mir umfassendes, detailliertes Wissen über Morp. in CL erarbeitet, Prinzip und Gründe für Unterschiedliche Verfahren und Resultete 
\todo[inline]{Weitere Inhalte ausformulieren}
