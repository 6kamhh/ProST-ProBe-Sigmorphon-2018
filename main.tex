...
Zuerst werden alle Traningsdaten analysiert, wobei für jedes Paar von aligniertem Lemma und Flexion Feature-spezifische Prefix- und Suffix-Regeln extrahiert werden. Eine solche Regel bildet das Lemma oder ein Teil des Lemmas auf die korrekte flektierte Form ab.
...
In dem neuronalen Netzwerk verwenden wir eine Encoder-Decoder Architektur \citep{encdec:ChoMGBSB14, seq2seq:SutskeverVL14}
